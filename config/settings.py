...
MIDDLEWARE = [
    'apps.core.middleware.PublicApiCorsMiddleware',
...
PAYPHONE_CONFIRM_URL = config('PAYPHONE_CONFIRM_URL', default='https://paymentbox.payphonetodoesposible.com/api/confirm').strip()
...
PAYPHONE_CARD_FEE_PERCENT = config('PAYPHONE_CARD_FEE_PERCENT', default='5').strip()
PAYPHONE_CARD_FEE_TAX_RATE = config('PAYPHONE_CARD_FEE_TAX_RATE', default='15').strip()
...
FIRMADOR_PUBLIC_BASE_URL = config('FIRMADOR_PUBLIC_BASE_URL', default='https://firmador.of1solutions.com').strip().rstrip('/')
