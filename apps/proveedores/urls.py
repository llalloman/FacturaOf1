...
from .views import (
    ProveedorViewSet, ProveedorProductoViewSet, OrdenCompraViewSet, RecepcionCompraViewSet,
    CuentaPorPagarViewSet, PagoProveedorViewSet
)

router = DefaultRouter()
router.register(r'proveedores', ProveedorViewSet, basename='proveedor')
router.register(r'catalogo', ProveedorProductoViewSet, basename='proveedor-producto')
