...
class FirmaPagoElectronico(models.Model):
    ...
    amount = models.DecimalField(_('monto total'), max_digits=10, decimal_places=2)
    base_amount = models.DecimalField(_('monto firma'), max_digits=10, decimal_places=2, default=0)
    processing_fee = models.DecimalField(_('recargo transacción'), max_digits=10, decimal_places=2, default=0)
    processing_fee_tax = models.DecimalField(_('IVA recargo transacción'), max_digits=10, decimal_places=2, default=0)
