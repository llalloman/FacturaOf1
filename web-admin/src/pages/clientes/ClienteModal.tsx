      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto border border-indigo-100">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-semibold text-indigo-900 mb-2">Teléfono</label>
              <input
                type="tel"
          ...
          {/* Dirección */}
          <div>
            <label className="block text-sm font-semibold text-indigo-900 mb-2">Dirección</label>
            <textarea
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <label htmlFor="activo" className="text-sm font-semibold text-indigo-900">
              Cliente Activo
            </label>
          </div>
