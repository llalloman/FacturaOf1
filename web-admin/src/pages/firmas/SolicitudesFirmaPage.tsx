...
const whatsappFor = (requestNumber?: string) => (
  `https://api.whatsapp.com/send/?phone=593991840854&text=${encodeURIComponent(`Hola, he realizado la solicitud de firma número ${requestNumber ?? ''}`)}&type=phone_number&app_absent=0`
);
