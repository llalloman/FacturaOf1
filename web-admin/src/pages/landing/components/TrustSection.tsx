...
const TRUST_ITEMS = [
  ...
  },
  {
    ...
    description: 'Prueba todas las funcionalidades durante 30 días sin ningún compromiso ni costo.',
  ...
  },
  {
    ...
    description: 'No necesitas ingresar datos de pago para empezar tu periodo de prueba gratuita.',
